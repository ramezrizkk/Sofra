# Sofra (Dalla3 Kershak) 🍽️

Welcome to **Sofra** (also known as *Dalla3 Kershak*), a premium recipe sharing and discovery web application built with Django. Sofra provides a beautiful, dark-mode-ready interface for food enthusiasts to explore, manage, rate, and save their favorite recipes.
